  ...
  const handleFinish = async (e) => {
    ...
    try {
      ...
      if (formData.panPhoto) {
        const panUpload = await uploadImage(formData.panPhoto);
        panPhotoUrl = panUpload.url;
      }
      if (formData.aadharPhoto) {
        const aadharUpload = await uploadImage(formData.aadharPhoto);
        aadharPhotoUrl = aadharUpload.url;
      }
      if (formData.nomineeAadharPhoto) {
        const nomineeUpload = await uploadImage(formData.nomineeAadharPhoto);
      ...
      const payload = {
        ...
        nomineeAadharNumber: formData.nomineeAadharNumber,
        nomineeAadharPhoto: nomineeAadharPhotoUrl,
      };
